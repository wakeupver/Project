...
android {
    ...
    // Cores are downloaded at runtime from buildbot.libretro.com — no dynamic features needed.
    ...
    signingConfigs {
        ...
        maybeCreate("release").apply {
            // Signing values are read from environment variables injected by CI.
            ...
            //
            // Locally, fall back to the checked-in debug keystore (never use in production).
            val keystorePath = System.getenv("KEYSTORE_FILE")
            storeFile = if (keystorePath != null) file(keystorePath) else file("$rootDir/debug.keystore")
...
dependencies {
    ...
    // bundled-cores removed: cores downloaded at runtime from buildbot.libretro.com
